...
export const ACCOUNT_LOGIN = {
    account: "Bạn có muốn xóa tài khoản này không ?",
    account_exists: "Tài khoản này đã tồn tại !"
}

export const ACCOUNT_SAVE = {
...
export const VALIDATOR_ADD_PRODUCT = {
    ...
    description: 'Vui lòng nhận mô tả cho sản phẩm'
};
